...
\newcommand{\homework}[7]{
   ...
   \framebox{
      \vbox{\vspace{2mm}
    \hbox to 6.28in { {\bf #1 \hfill {\small #3}} }
       \vspace{6mm}
       \hbox to 6.28in { {\Large \hfill #2  \hfill} }
       \vspace{6mm}
       \hbox to 6.28in { {\it Lecturer: {\rm #4} \hfill Name: {\rm #6} {\rm #7}} }
       %\hbox to 6.28in { {\it TA: #4  \hfill #6}} ג
      \vspace{2mm}}
   }
   \end{center}
   \markboth{#6 -- #1}{#6 -- #1}
...
\newcommand{\tblu}[1]{\textcolor{blueColor}{#1}}
